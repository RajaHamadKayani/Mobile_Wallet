...
class PickIdCard extends StatefulWidget {
  const PickIdCard({super.key});

  @override
  State<PickIdCard> createState() => _PickIdCardState();
}

class _PickIdCardState extends State<PickIdCard>
    with SingleTickerProviderStateMixin {
  var imageBox;
  List<Uint8List> imagesList = [];

  Future<void> getBoxName() async {
    imageBox = await Hive.openBox<Uint8List>("id_cards");
