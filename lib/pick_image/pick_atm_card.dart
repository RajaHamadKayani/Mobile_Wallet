...
class PickAtmCard extends StatefulWidget {
  const PickAtmCard({super.key});

  @override
  State<PickAtmCard> createState() => _PickAtmCardState();
}

class _PickAtmCardState extends State<PickAtmCard>
